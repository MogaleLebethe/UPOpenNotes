...
\phantomsection
\addcontentsline{toc}{subsection}{Chapter 2: Operating System Overview}
\bookmark[page=\thepage,level=2]{Chapter 2: Operating System Overview}
\setcounter{figure}{0}

\subsubsection*{Unit 2.1: Operating System Objectives and Functions}
\phantomsection
\addcontentsline{toc}{subsubsection}{Unit 2.1: Operating System Objectives and Functions}
\bookmark[page=\thepage,level=3]{Operating System Objectives and Functions}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/Ch02Figure1.png} % path to your figure
...
\phantomsection
\addcontentsline{toc}{subsubsection}{Unit 2.2: Evolution of Operating Systems}
\bookmark[page=\thepage,level=3]{Evolution of Operating Systems}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Ch02Figure2.png} % path to your figure
...
\begin{itemize}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=0.4\textwidth]{figures/Ch02Figure3.png} % path to your figure
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=0.3\textwidth]{figures/Ch02Figure4.png} % path to your figure
